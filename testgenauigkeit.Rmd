...
(Achtung, das Dezimalzeichen ist der Punkt).",
  answer_fn(function(input) {
    ...
    if (!is.null(result) && identical(round(result, 4), round(expected_result, 4))) {
...
",
  answer_fn(function(input) {
    ...
    if (!is.null(result) && identical(round(result, 2), round(expected_result, 2))) {
...
(Achtung, das Dezimalzeichen ist der Punkt).",
  answer_fn(function(input) {
    ...
    if (!is.null(result) && identical(round(result, 2), round(expected_result, 2))) {
        correct(sprintf("Das Ergebnis ist %.4f.", result))
    } else {
        incorrect(NULL)
    }
  }),
