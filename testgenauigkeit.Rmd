...
Konfusionsmatrix, abgebildet in der Zusammenfassung auf der rechten Seite.
...
```{r survey_kommentar}
question_text("Wie ist Ihr genereller Eindruck zu dieser Lernanwendung?",
...
question("Wie hilfreich finden Sie die Zusammenfassungsleiste auf der rechten Seite?",
  answer("1", label = "Gar nicht hilfreich.", correct = TRUE),
  answer("2", label = "Überwiegend nicht hilfreich.", correct = TRUE),
  answer("3", label = "Überwiegend hilfreich.", correct = TRUE),
  answer("4", label = "Sehr hilfreich.", correct = TRUE),
  type = "learnr_radio",
  allow_retry = FALSE,
  correct = "Danke."
)
