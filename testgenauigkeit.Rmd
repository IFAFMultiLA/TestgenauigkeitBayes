...
- $\color{teal}{\overline K}$: Person gesund
- $\color{darkred}{T}$: Test positiv
- $\color{blue}{\overline T}$: Test negativ

::: summary

#### Definition der Ereignisse

- $\color{red}{K}$:Person krank und $\color{teal}{\overline K}$: Person gesund
- $\color{darkred}{T}$: Test positiv und $\color{blue}{\overline T}$: Test negativ
