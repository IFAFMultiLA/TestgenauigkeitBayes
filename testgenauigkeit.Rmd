...
in der Bevölkerung (d.h. die Prävelenz) wider. Berechnen Sie diese Prävalenz $P(K)$ aus den Daten in der 
Konfusionsmatrix, abgebildet in der Zusammenfassung auf der echten Seite.
...
```{r P_K_T}
question_text(
  "Berechnen Sie die totale Wahrscheinlichkeit $P(K|T)$, dass eine positiv getestete Person tatsächlich krank ist.
